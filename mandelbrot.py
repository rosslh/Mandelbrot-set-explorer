...
class Mandelbrot(Frame):
    def __init__(self, xCenter, yCenter, delta, h, w, bailout, paletteSize,
        ...
        self.palette = self.getPalette(self.paletteSize)
        ...
        for x in range(self.w):
            for y in range(self.h):
                ...
                if escapeTime[0]:
                    ...
                    self.drawPixel(x, y, color, self.canvas)
                else:
                    self.drawPixel(x, y, '#000000', self.canvas)
    ...
    def drawPixel(self, x, y, color, canvas):
    ...
    def getPalette(self, paletteSize):
        palette = []
        ...
        for i in range(paletteSize):
            ...
            r, g, b = self.clamp(red), self.clamp(green), self.clamp(blue)
...
def main():
    ...
    ex = Mandelbrot(-0.7, 0, 1.7, height, width, 100, 256, master)
